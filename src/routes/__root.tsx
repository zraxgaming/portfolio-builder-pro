...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio Builder Pro is a web application for creating and managing professional developer portfolios." },
      { property: "og:description", content: "Portfolio Builder Pro is a web application for creating and managing professional developer portfolios." },
      { name: "twitter:description", content: "Portfolio Builder Pro is a web application for creating and managing professional developer portfolios." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/024a66b4-c7d9-4fba-b217-745019f0723e/id-preview-43bce300--662cd02b-bbbb-4818-af96-4f7232a3c47f.lovable.app-1778156610298.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/024a66b4-c7d9-4fba-b217-745019f0723e/id-preview-43bce300--662cd02b-bbbb-4818-af96-4f7232a3c47f.lovable.app-1778156610298.png" },
    ],
    links: [
